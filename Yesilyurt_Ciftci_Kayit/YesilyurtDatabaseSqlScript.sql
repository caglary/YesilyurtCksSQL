...
go
Alter Table Cks 
Add EvrakKayitNo nvarchar(10), HavaleEdilenPersonel nvarchar(30),MuracaatYeri nvarchar(50)
go
...
@KullaniciId int ,
@CreateTime datetime,
@EvrakKayitNo nvarchar(10),
@HavaleEdilenPersonel nvarchar(30),
@MuracaatYeri nvarchar(50)
)
as 
begin
	insert into Cks (CiftciId,DosyaNo,Note,KullaniciId,CreateTime,EvrakKayitNo,HavaleEdilenPersonel,MuracaatYeri) values 
...
as
begin
	update Cks set CiftciId=@CiftciId,DosyaNo=@DosyaNo,Note=@Note,
	KullaniciId=@KullaniciId,CreateTime=@CreateTime,EvrakKayitNo=@EvrakKayitNo,
	HavaleEdilenPersonel=@HavaleEdilenPersonel, MuracaatYeri=@MuracaatYeri where Id=@Id
end
go
...
Ciftciler.MobilePhone,Ciftciler.HomePhone,Ciftciler.Village,cks.Note,Cks.CreateTime,cks.EvrakKayitNo,cks.HavaleEdilenPersonel,cks.MuracaatYeri
...
Ciftciler.MobilePhone,Ciftciler.HomePhone,Ciftciler.Village,Cks.CreateTime,cks.EvrakKayitNo,cks.HavaleEdilenPersonel,cks.MuracaatYeri
...
as 
begin
	insert into TMOKayitlar (CksId,EvrakKayitNo,EvrakKayitTarihi,Note,FirmaId,FaturaNo,FaturaTarihi,ProductId,Amount,KullaniciId,CreateTime,Donem)
...
as
begin
	update TMOKayitlar set CksId=@CksId,FirmaId=@FirmaId ,EvrakKayitNo=@EvrakKayitNo, EvrakKayitTarihi=@EvrakKayitTarihi, Note=@Note,
	FaturaNo=@FaturaNo, FaturaTarihi=@FaturaTarihi,ProductId=@ProductId, Amount=@Amount , KullaniciId=@KullaniciId , CreateTime=@CreateTime,
...
select 
TMOKayitlar.Id,
Cks.DosyaNo as [ÇKS Dosya No],
Ciftciler.TcKimlikNo,
Ciftciler.NameSurname as [Ýsim Soyisim],
Ciftciler.Village as [Mahalle/Köy],
Ciftciler.MobilePhone as [Cep Telefonu],
TMOKayitlar.FaturaNo as [Fatura No],
TMOKayitlar.FaturaTarihi as [Fatura Tarihi],
Urun.UrunAdi as [Ürün],
TMOKayitlar.Amount as [Miktar (kg)],
TMOKayitlar.Note as [Not],
