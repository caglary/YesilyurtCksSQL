...
namespace Yesilyurt_Ciftci_Kayit.Utilities
{
    public static class ConnectionString
    {
        ...
        public static string Get()
        {
            ...
            string Work2022 = @"Server=M601102-0009;Database=YesilyurtDb2022;User Id=sa;Password=Password.123;";
            string Work2021 = @"Server=M601102-0009;Database=YesilyurtDb2021;User Id=sa;Password=Password.123;";
            string Work2023 = @"Server=M601102-0009;Database=YesilyurtDb2023;User Id=sa;Password=Password.123;";
