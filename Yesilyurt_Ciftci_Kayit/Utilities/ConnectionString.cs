...
namespace Yesilyurt_Ciftci_Kayit.Utilities
{
    public static class ConnectionString
    {
        ...
        public static string Get()
        {
            ...
            string Lenovo2022 = @"Server=M601102-0012;Database=YesilyurtDb2022;User Id=sa;Password=Password.123;";
            string Lenovo2021 = @"Server=M601102-0012;Database=YesilyurtDb2021;User Id=sa;Password=Password.123;";
            string Lenovo2023 = @"Server=M601102-0012;Database=YesilyurtDb2023;User Id=sa;Password=Password.123;";
            string Lenovo2024 = @"Server=M601102-0012;Database=YesilyurtDb2024;User Id=sa;Password=Password.123;";
